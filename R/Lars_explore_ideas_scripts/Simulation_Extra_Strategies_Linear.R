...
# Get the weights
dt_new_weights_analytical = readRDS(file.path(folder, paste0("Analytical_prop_M_", 17, "_res.rds")))
dt_new_weights_sequence = readRDS(file.path(folder, paste0("Sequence_length_M_17_combined.rds")))
