...
weight_versions = c("analytical", "non_analytical")
resave = TRUE



message("Reading TRUE")
true = readRDS(paste0("/mn/kadingir/biginsight_000000/lholsen/PhD/Paper3/Paper3_save_location/Wine_data_sep_rf.rds"))
...
for (version in versions) {
  if (version == "unique_paired") {
    file_name = "/mn/kadingir/biginsight_000000/lholsen/PhD/Paper3/Paper3_save_location/NEW_Wine_data_res_unique_paired.rds"
  } else if (version == "largest_weights_random") {
    file_name = "/mn/kadingir/biginsight_000000/lholsen/PhD/Paper3/Paper3_save_location/NEW_Wine_data_res_largest_weights_random_new_weights_empirical.rds"
  } else {
  ...
  for (version in versions) {
    ...
    for (strategy in new_strategies) {
      for (weight_version in weight_versions) {
        ...
        save_name = paste0("/mn/kadingir/biginsight_000000/lholsen/PhD/Paper3/Paper3_save_location/M_17_n_train_1000_n_test_500_rho_", rho, "_equi_FALSE_betas_2_10_0.25_-3_-1_1.5_-0.5_10_1.25_1.5_-2_3_-1_-5_4_-10_2_5_estimated_repetition_", repetition ,"_", strategy_name, ".rds")
        ...
        for (n_comb_now_idx in seq_along(n_combinations)) {
          ...
          if (n_combinations[n_comb_now_idx] == 2) {
            ...
            # save_list[[strategy_name]][[1]][[file_relevant_names[n_comb_now_idx]]]$internal$parameters$precomputed_vS = NULL
            ...
            if (weight_version == "analytical") {
              dt_new_weights = readRDS(paste0("/mn/kadingir/biginsight_000000/lholsen/PhD/Paper3/Paper3_save_location/Analytical_prop_M_", 17, "_res.rds"))
